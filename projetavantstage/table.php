...
$sql = "SELECT title, publishers.name as publishers, platform.name as platform, genres.name as genreG, gamesgenres.idGenre as genre, developers.name as dev ,constructor.name as constr, numero FROM videogames LEFT OUTER JOIN publishers ON publishers.id=videogames.idPublisher LEFT OUTER JOIN platform ON platform.id = videogames.idPlatform LEFT OUTER JOIN gamesgenres ON gamesgenres.idVideoGame = videogames.id LEFT OUTER JOIN genres ON genres.id= gamesgenres.idGenre LEFT OUTER JOIN developers ON developers.id = videogames.idDeveloper LEFT OUTER JOIN constructor ON constructor.id = platform.idConstructor";
